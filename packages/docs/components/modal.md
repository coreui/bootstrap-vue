...
name: Bootstrap Vue Modal Component
description: Bootstrap Vue Modal component offers a lightweight, multi-purpose popup to add dialogs to yours. Learn how to customize Bootstrap Vue Modals easily. Multiple examples and tutorial.
layout: Docs
---

---
title: Navs & Tabs Components
name: Bootstrap Vue Navs & Tabs Components
description: Documentation and examples for how to use Bootstrap Vue's included navigation components.
...
Navigation available in Bootstrap Vue share general markup and styles, from the base `.nav` class to the active and disabled states. Swap modifier classes to switch between each style.

# Contributing to Bootstrap Vue

Looking to contribute something to Bootstrap Vue? **Here's how you can help.**
...
The [issue tracker](https://github.com/coreui/bootstrap-vue/issues) is
...
1. [Fork](https://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git remote add upstream https://github.com/coreui/bootstrap-vue.git
   ```
